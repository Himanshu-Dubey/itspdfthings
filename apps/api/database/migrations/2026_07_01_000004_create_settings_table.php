...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::table('settings')->insert([
            ...
            ['key' => 'file_size_limit_premium_bytes', 'value' => '104857600', 'type' => 'integer', 'group' => 'limits', 'description' => 'Max upload file size for premium users (bytes)', 'created_at' => now(), 'updated_at' => now()],
