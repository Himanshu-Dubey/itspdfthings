    ...
    <div>
      ...
      <div className="max-w-3xl mx-auto px-4 pb-16">
          ...
          config={{
            ...
            fields: [
              ...
              },
              {
                ...
                defaultValue: "above",
                options: [
                  { value: "above", label: "Above content — watermark on top" },
                  { value: "below", label: "Below content — watermark behind" },
                ],
              },
            ],
          }}
        ...
        <ToolInfoCard title="About watermarks">
          <p>The watermark is rendered in grey at your chosen opacity and angle, centered on every page. Choose whether it sits above or below your content.</p>
        </ToolInfoCard>
